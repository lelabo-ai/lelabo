...
python plots/plot_sweep.py \
  --config configs/compare_rl.yaml \
  --mode curve \
  --x total_steps \
  --y rl_update.roll_mean_return_20 \
  --hue algo \
  --out plots/rl_curve.png
